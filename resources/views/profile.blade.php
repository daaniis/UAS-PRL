                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="settings">
                                            <form class="form-horizontal" action="{{ $URL . '/user29' }}"
                                                method="POST">
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputTanggalLahir"
                                                        class="col-sm-2 col-form-label">Barang</label>
                                                    <div class="col-sm-10">
                    ...
                    <br>
                            <div class="card card-success card-outline">
                                ...
                                <div class="card-header text-center bg-dark text-white mb-2">
                                    ...
                                    @if (!$is_preview)
                                        ...
                                        <form enctype='multipart/form-data' action="{{ $URL . '/user29/photo' }}"
                                            method="POST">
                                            @csrf
                            ...
                            <div class="card card-danger card-outline">
                                ...
                                <div class="card-header text-center bg-dark text-white mb-2">
                                    ...
                                    @if (!$is_preview)
                                    <form enctype='multipart/form-data' action="{{ $URL . '/user29/photoKTP' }}"
                                            method="POST">
                                            @csrf
