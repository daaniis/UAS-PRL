        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><b>CRUD Barang</b></h1>
                        </div>

                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">CRUD Barang</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                        ...
                                        <tbody>
                                            @foreach ($all_agama as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ $URL }}/agama29/{{ $item['id'] }}/edit"
                                                            class="btn btn-warning">Edit</a>
                                                        <a href="{{ $URL }}/agama29/{{ $item['id'] }}/delete"
                        ...
                        <div class="col-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form
                                        @if (isset($agama)) action="{{ $URL }}/agama29/{{ $agama['id'] }}/update"
                                    @else
                                        action="{{ $URL }}/agama29" @endif
                                        method="POST">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                                aria-describedby="emailHelp" placeholder="Nama Barang" name="nama_agama"
