...
class User29Controller extends Controller
{
    ...
    public function getUserDetail29(Request $request, $id)
    {
    ...
    public function putUserDetail29(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPhoto29(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPhotoKTP29(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPassword29(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserAgama29(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'id_agama' => 'required|exists:agama29,id',
        ]);
        ...
        if ($updateAgama) {
            return new FormatApi(true, 'Berhasil mengubah Barang user', null);
        } else {
            return new FormatApi(false, 'Gagal mengubah Barang user', null);
        }
    }
